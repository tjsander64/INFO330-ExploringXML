...
<!-- In this template, select all the pokemon that are fire, water, flying or ground -->
<xsl:template match="/pokedex">
  <xsl:variable name="pokemonResults" select="pokemon[type='fire' or type='water' or type='ground' or type='flying']" />
...
<!-- in this one I was troubleshooting an error, and copypasted the updated version of 
the incomplete assigment from the repo - the rest of these I just used the original file

also, I never figured out how to make the pretty html work out lol just stuck with the text-->